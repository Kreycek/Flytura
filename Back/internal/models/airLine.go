...
type AirLine struct {
	...
	ImportSheetOnlyVerifyNumber bool               `json:"importSheetOnlyVerifyNumber" bson:"importSheetOnlyVerifyNumber,omitempty"`
	IdUserUpdate                string             `json:"idUserUpdate" bson:"idUserUpdate,omitempty"`
	QtdMinCharKey               int                `json:"qtdMinCharKey" bson:"qtdMinCharKey,omitempty"`
}
