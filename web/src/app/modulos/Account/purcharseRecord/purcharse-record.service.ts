...
export class PurcharseRecordService {
  ...
  searchPurchaseRecordData(data:any): Observable<any> {
   ...
   searchPurchaseRecordDataByPeriod(data:any): Observable<any> {
    return this.http.post(this.configService.apiUrl + "/SearchPurcharseRecordByPeriod", data, {
      headers: new HttpHeaders({
        'Content-Type': 'application/json',
      }),
    });
  ...
  if (endDate) {
    ...
    return this.http.get(this.configService.apiUrl + '/AgregateByImportDateAndStatus', {
    headers: new HttpHeaders({
      'Content-Type': 'application/json',
    }),
    params: params
...
GroupByCompanyName(
  ...
  return this.http.get(this.configService.apiUrl + '/GroupByCompanyName', {
    ...
    deletePurcharseRecord(id:string): Observable<any> {
    return this.http.delete(this.configService.apiUrl + `/DeletePurcharseRecordByID/${id}`, {
      headers: new HttpHeaders({
        'Content-Type': 'application/json',
      }),
    });
